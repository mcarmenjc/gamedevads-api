...
$app->get('/api/createImpressions','AdDimension\Controller\ImpressionController:post');
$app->get('/api/impressions','AdDimension\Controller\ImpressionController:fetch');
...
$app->get('/api/createClicks','AdDimension\Controller\ClickController:post');
$app->get('/api/clicks','AdDimension\Controller\ClickController:fetch');
